...
<head>
    ...
    <title>Same Day Tours - India Day Trip | Delhi & Agra Day Trips</title>
    <meta name="author" content="India Day Trip">
    <meta name="description" content="Explore our Same Day Tours from Delhi including Taj Mahal visits, Old Delhi food tasting, and private car tours. Perfect for short trips to Agra and Delhi.">
    <meta name="keywords" content="Same Day tours Delhi, Taj Mahal day trip, Old Delhi food tour, Agra day tour, private car tour Delhi">
                    ...
                    <div class="col-md-4">
                        <div class="search-form-area">
                            <form class="search-form">
                                <input type="text" placeholder="Search Same Day Tours">
                                <button type="submit">
                    ...
                    <aside class="sidebar-area">
                        ...
                        <div class="widget">
                            ...
                            <div class="recent-post-wrap">
                                ...
                                <div class="recent-post">
                                    ...
                                    <div class="media-body">
                                        <h4 class="post-title">
                                            <a class="text-inherit" href="../gallery/index.php">Best Day Trips from Delhi</a>
                                        </h4>
                                        <div class="recent-post-meta">
                                            <a href="../index.php">
                                ...
                                <div class="recent-post">
                                    ...
                                    <div class="media-body">
                                        <h4 class="post-title">
                                            <a class="text-inherit" href="../gallery/index.php">Private Car Tours in Delhi</a>
                                        </h4>
                                        <div class="recent-post-meta">
                                            <a href="../index.php">
                        ...
                        <div class="widget widget_tag_cloud">
                            ...
                            <div class="tagcloud">
                                ...
                                <a href="../index.php">Food Tour</a>
                                <a href="../index.php">Private Car</a>
                                <a href="../index.php">Taj Mahal</a>
                                <a href="../index.php">Day Trip</a>
