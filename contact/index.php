    ...
    <div class="space-extra2-top space-extra2-bottom" data-bg-src="../assets/img/bg/video_bg_1.jpg">
        <div class="container">
            <div class="row flex-row-reverse justify-content-center align-items-center">
                ...
                <div class="col-lg-6">
                    <div>
                        <form action="https://html.themehour.net/tourm/demo/mail.php" method="POST" class="contact-form style2 ajax-contact">
                            <h3 class="sec-title mb-30 text-capitalize">Book a tour</h3>
                            <div class="row">
                                <div class="col-12 form-group"><input type="text" class="form-control" name="name" id="name3" placeholder="First Name"> <img src="../assets/img/icon/user.svg" alt=""></div>
