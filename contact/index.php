            ...
            <div class="row contact-cards-row mb-5">
                        ...
                        <ul class="list-unstyled mb-4">
                            <li class="d-flex align-items-start">
                                ...
                                <span>
                                    ...
                                    Shop No. 2, Gupta Market, Tajganj, Agra, Uttar Pradesh, India
                                </span>
                            </li>
                            <li class="d-flex align-items-start">
                                ...
                                <span>
                                    ...
                                    <a href="mailto:info@indiadaytrip.com">info@indiadaytrip.com</a>
                                </span>
                            </li>
                            <li class="d-flex align-items-start">
                                ...
                                <span>
                                    ...
                                    <a href="tel:+918126052755">+91 81260 52755</a>
                                </span>
                            </li>
                            <li class="d-flex align-items-start">
                ...
                <div class="col-lg-6 d-flex">
                    <div class="contact-form-box w-100">
                        ...
                        <form action="../api/mail.php" method="POST" class="row g-3 ajax-contact" id="contactForm">
        ...
        document.getElementById('contactForm').addEventListener('submit', function (e) {
            ...
            fetch('api/mail.php', {
                ...
                .catch(error => {
                    ...
                    if (errorAlert) {
                        errorAlert.textContent = 'Sorry, there was an error. Please try again.';
                        errorAlert.classList.remove('d-none');
                    }
                });
        });
