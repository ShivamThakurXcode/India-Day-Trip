...
<head>
    ...
    <meta property="og:image" content="https://indiadaytrip.com/assets/img/destination/d-jaipur.png">
    ...
    <meta property="twitter:image" content="https://indiadaytrip.com/assets/img/destination/d-jaipur.png">
                            ...
                            <div class="row gy-24 gx-24">
                                ...
                                <div class="col-xxl-4 col-lg-4 col-md-6">
                                    <div class="tour-box th-ani">
                                        ...
                                        <div class="tour-content">
                                            <h3 class="box-title">
                                                <a href="../to_book/index.php">2 Days Agra And Jaipur Tour From Delhi</a>
                                            </h3>
                                            <div class="tour-rating">
                                                <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5">
                                                    <span style="width:100%">Rated <strong class="rating">5.00</strong> out of 5 based on <span class="rating">4.8</span>(4.8 Rating)</span>
                                ...
                                <div class="col-xxl-4 col-lg-4 col-md-6">
                                    <div class="tour-box th-ani">
                                        <div class="tour-box_img global-img">
                                            <img src="../assets/img/tours-image/golden-tour.png" alt="Golden Triangle Tour 3N4D">
                                        </div>
                                        <div class="tour-content">
                                            <h3 class="box-title">
                                                <a href="../to_book/index.php">Golden Triangle Tour 3N4D</a>
                                            </h3>
                                            <div class="tour-rating">
                                                <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5">
                                                    <span style="width:100%">Rated <strong class="rating">5.00</strong> out of 5 based on <span class="rating">4.8</span>(4.8 Rating)</span>
