                    ...
                    <div class="col-md-4">
                        <div class="search-form-area">
                            <form class="search-form">
                                <input type="text" placeholder="Search Rajasthan Tours">
                                <button type="submit">
                        ...
                        <div class="tab-pane fade active show" id="tab-grid" role="tabpanel" aria-labelledby="tab-tour-grid">
                            <div class="row gy-24 gx-24">
                                    ...
                                    <div class="tour-box th-ani">
                                        ...
                                        <div class="tour-content">
                                            ...
                                            <div class="tour-action">
                                                <span>
                                                    <i class="fa-light fa-clock"></i>6 Days
                                                </span>
                                ...
                                <div class="col-xxl-4 col-lg-4 col-md-6">
                                    <div class="tour-box th-ani">
                                        ...
                                        <div class="tour-content">
                                            ...
                                            <div class="tour-action">
                                                <span>
                                                    <i class="fa-light fa-clock"></i>5 Days
                                                </span>
                                                <a href="../contact.php" class="th-btn style4">Book Now</a>
                                            </div>
                                        </div>
                                ...
                                <div class="col-xxl-4 col-lg-4 col-md-6">
                                    <div class="tour-box th-ani">
                                        <div class="tour-box_img global-img">
                                            <a href="../tour/from-delhi-2days-agra-and-jaipur-tour-by-car">
                                                <img src="../assets/img/tours-image/golden-tour.webp" alt="2 Days Agra And Jaipur Tour From Delhi">
                                            </a>
                                        </div>
                                        <div class="tour-content">
                                            <h3 class="box-title">
                                                <a href="../tour/from-delhi-2days-agra-and-jaipur-tour-by-car">2 Days Agra And Jaipur Tour From Delhi</a>
                                            </h3>
                                            <div class="tour-rating">
                                                <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5">
                                                    <span style="width:100%">Rated <strong class="rating">5.00</strong> out of 5 based on <span class="rating">4.8</span>(4.8 Rating)</span>
                                                </div>
                                                <a href="../tour/from-delhi-2days-agra-and-jaipur-tour-by-car/" class="woocommerce-review-link">(<span class="count">4.8</span> Rating)</a>
                                            </div>
                                            <div class="tour-action">
                                                <span>
                                ...
                                <div class="col-xxl-4 col-lg-4 col-md-6">
                                    <div class="tour-box th-ani">
                                        <div class="tour-box_img global-img">
                                            <a href="../tour/golden-triangle-tour-2n3d">
                                                <img src="../assets/img/tours-image/golden-tour.webp" alt="Golden Triangle Tour 3N4D">
                                            </a>
                                        </div>
                                        <div class="tour-content">
                                            <h3 class="box-title">
                                                <a href="../tour/golden-triangle-tour-2n3d">Golden Triangle Tour 3N4D</a>
                                            </h3>
                                            <div class="tour-rating">
                                                <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5">
                                                    <span style="width:100%">Rated <strong class="rating">5.00</strong> out of 5 based on <span class="rating">4.8</span>(4.8 Rating)</span>
                                                </div>
                                                <a href="../tour/golden-triangle-tour-2n3d/" class="woocommerce-review-link">(<span class="count">4.8</span> Rating)</a>
                                            </div>
                                            <div class="tour-action">
                                                <span>
                                                    <i class="fa-light fa-clock"></i>4 Days
                                                </span>
                                                <a href="../contact.php" class="th-btn style4">Book Now</a>
                                            </div>
                                        </div>
                ...
                <div class="col-xxl-3 col-lg-4">
                    <aside class="sidebar-area">
                            ...
                            <div class="recent-post-wrap">
                                <div class="recent-post">
                                    ...
                                    <div class="media-body">
                                        <h4 class="post-title">
                                            <a class="text-inherit" href="../gallery/index.php">Jaipur City Palace</a>
                                        </h4>
                                ...
                                <div class="recent-post">
                                    ...
                                    <div class="media-body">
                                        <h4 class="post-title">
                                            <a class="text-inherit" href="../gallery/index.php">Udaipur Lake Palace</a>
                                        </h4>
                                        <div class="recent-post-meta">
                                            <a href="../index.php">
                                ...
                                <div class="recent-post">
                                    ...
                                    <div class="media-body">
                                        <h4 class="post-title">
                                            <a class="text-inherit" href="../gallery/index.php">Ranthambore Tiger Reserve</a>
                                        </h4>
                                        <div class="recent-post-meta">
                                            <a href="../index.php">
                        ...
                        <div class="widget widget_tag_cloud">
                            ...
                            <div class="tagcloud">
                                <a href="../index.php">Rajasthan</a>
                                <a href="../index.php">Jaipur</a>
                                <a href="../index.php">Udaipur</a>
                                <a href="../index.php">Ranthambore</a>
                                <a href="../index.php">Desert</a>
                                <a href="../index.php">Palaces</a>
                                <a href="../index.php">Forts</a>
