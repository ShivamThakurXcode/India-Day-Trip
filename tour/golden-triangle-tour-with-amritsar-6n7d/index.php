...
<head>
    ...
    <title>Golden Triangle Tour with Amritsar - India Day Trip</title>
    <meta name="author" content="India Day Trip">
    <meta name="description"
        content="Explore India's Golden Triangle plus the spiritual city of Amritsar on this 7-day tour. Visit Taj Mahal, Golden Temple, and Mughal monuments.">
    <meta name="keywords" content="Golden Triangle Amritsar, India Sikh heritage, Delhi Agra Jaipur Amritsar, Golden Temple tour, Punjab culture">
    ...
    <div class="breadcumb-wrapper" data-bg-src="../assets/img/bg/breadcumb-bg.jpg">
        <div class="container">
            <div class="breadcumb-content">
                <h1 class="breadcumb-title">Golden Triangle Tour with Amritsar</h1>
                <ul class="breadcumb-menu">
                    <li><a href="home-travel.php">Home</a></li>
                    <li>Golden Triangle Amritsar</li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="tour-page-single">
              ...
              >
                ...
                >
                  <div class="tour-slider-img">
                    <img src="assets/img/tour/golden_amritsar_1.jpg" alt="Golden Triangle Amritsar" />
                  </div>
                </div>
                <div
                  class="swiper-slide"
                ...
                >
                  <div class="tour-slider-img">
                    <img src="assets/img/tour/golden_amritsar_2.jpg" alt="Golden Triangle Amritsar" />
                  </div>
                </div>
                <div
                  class="swiper-slide"
                ...
                >
                  <div class="tour-slider-img">
                    <img src="assets/img/tour/golden_amritsar_3.jpg" alt="Golden Triangle Amritsar" />
                  </div>
                </div>
                <div
                  class="swiper-slide"
          ...
          <div class="page-content">
            ...
            <p class="box-text mb-50">
              This 7-day journey combines Delhi's history, Agra's Taj Mahal, Jaipur's palaces with Amritsar's sacred sites, offering a comprehensive exploration of India's Mughal and Sikh heritage.
            </p>
            <h2 class="box-title">Highlights</h2>
            <p class="box-text mb-30">
              Discover India's Golden Triangle and Sikh heritage with our comprehensive 7-day itinerary.
            </p>
            <div class="checklist mb-50">
              <ul>
                <li>Delhi's Red Fort and India Gate</li>
                <li>Taj Mahal and Agra Fort exploration</li>
                <li>Jaipur's Amber Fort and City Palace</li>
                <li>Amritsar's Golden Temple (Harmandir Sahib)</li>
                <li>Wagah Border ceremony</li>
                <li>Jallianwala Bagh and Partition Museum</li>
                <li>Punjabi cuisine and cultural experiences</li>
              </ul>
            </div>
            <h2 class="box-title">Included and Excluded</h2>
            <p class="blog-text mb-35">
              Everything you need for a comfortable exploration of India's Golden Triangle and Amritsar is included.
            </p>
                ...
                <div class="tour-grid-plan">
                  <div class="checklist">
                    <ul>
                      ...
                      <li>Visit Red Fort and Jama Masjid.</li>
                      <li>
      ...
      <div class="col-xxl-4 col-lg-5">
        <aside class="sidebar-area">
            ...
            <div class="recent-post-wrap">
              <div class="recent-post">
                ...
                <div class="media-body">
                  <h4 class="post-title">
                    <a class="text-inherit" href="golden-triangle-tour-4n5d.html"
                      >Golden Triangle Tour 4N5D</a
                    >
                  </h4>
              ...
              <div class="recent-post">
                <div class="media-img">
                  <a href="golden-triangle-tours-with-varanasi-5n6d.html"
                    ><img
                      src="assets/img/blog/golden-varanasi-1.jpg"
                      alt="Golden Triangle Varanasi Tour"
                  /></a>
                </div>
                <div class="media-body">
                  <h4 class="post-title">
                    <a class="text-inherit" href="golden-triangle-tours-with-varanasi-5n6d.html"
                      >Golden Triangle Tour with Varanasi</a
                    >
                  </h4>
                  <div class="recent-post-meta">
                    <a href="tour.html"
              ...
              <div class="recent-post">
                <div class="media-img">
                  <a href="golden-triangle-tour-with-udaipur-7n8d.html"
                    ><img
                      src="assets/img/blog/golden-udaipur-1.jpg"
                      alt="Golden Triangle Udaipur Tour"
                  /></a>
                </div>
                <div class="media-body">
                  <h4 class="post-title">
                    <a class="text-inherit" href="golden-triangle-tour-with-udaipur-7n8d.html"
                      >Golden Triangle Tour with Udaipur</a
                    >
                  </h4>
                  <div class="recent-post-meta">
                    <a href="tour.html"
          ...
          <div class="widget widget_tag_cloud">
            ...
            <div class="tagcloud">
              <a href="tour.html">Golden Triangle</a> <a href="tour.html">Amritsar</a>
              <a href="tour.html">Golden Temple</a> <a href="tour.html">Sikh</a>
              <a href="tour.html">Delhi</a> <a href="tour.html">Agra</a>
              <a href="tour.html">Jaipur</a> <a href="tour.html">India</a>
