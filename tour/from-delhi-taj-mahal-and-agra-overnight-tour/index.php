            ...
            <div class="recent-post-wrap">
              <div class="recent-post">
                ...
                <div class="media-body">
                  <h4 class="post-title">
                    <a class="text-inherit" href="taj-mahal-tour-by-gatimaan-express-train.html"
                      >Taj Mahal Tour by Gatimaan Express</a
                    >
                  </h4>
              ...
              <div class="recent-post">
                <div class="media-img">
                  <a href="taj-mahal-sunrise-tour-from-delhi.html"
                    ><img
                ...
                <div class="media-body">
                  <h4 class="post-title">
                    <a class="text-inherit" href="taj-mahal-sunrise-tour-from-delhi.html"
                      >Taj Mahal Sunrise Tour From Delhi</a
                    >
                  </h4>
                  <div class="recent-post-meta">
                    <a href="tour.html"
              ...
              <div class="recent-post">
                <div class="media-img">
                  <a href="taj-mahal-and-agra-tour-by-premium-cars.html"
                    ><img
                      src="assets/img/blog/taj-agra-premium-1.jpg"
                      alt="Taj Mahal Agra Premium Tour"
                  /></a>
                </div>
                <div class="media-body">
                  <h4 class="post-title">
                    <a class="text-inherit" href="taj-mahal-and-agra-tour-by-premium-cars.html"
                      >Taj Mahal And Agra Tour By Premium Car</a
                    >
                  </h4>
                  <div class="recent-post-meta">
                    <a href="tour.html"
