        ...
        <aside class="sidebar-area">
          ...
          <div class="widget">
            ...
            <div class="recent-post-wrap">
              ...
              <div class="recent-post">
                <div class="media-img">
                  <a href="delhi-private-day-tour-by-car.html"
                    ><img
                      src="assets/img/blog/delhi-private-1.jpg"
                      alt="Delhi Private Tour"
                  /></a>
                </div>
                <div class="media-body">
                  <h4 class="post-title">
                    <a class="text-inherit" href="delhi-private-day-tour-by-car.html"
                      >Delhi Private Day Tour by Car</a
                    >
                  </h4>
                  <div class="recent-post-meta">
                    <a href="tour.html"
              ...
              <div class="recent-post">
                <div class="media-img">
                  <a href="evening-delhi-city-tour.html"
                    ><img
                      src="assets/img/blog/evening-delhi-1.jpg"
                      alt="Evening Delhi Tour"
                  /></a>
                </div>
                <div class="media-body">
                  <h4 class="post-title">
                    <a class="text-inherit" href="evening-delhi-city-tour.html"
                      >Evening Delhi City Tour</a
                    >
                  </h4>
                  <div class="recent-post-meta">
                    <a href="tour.html"
