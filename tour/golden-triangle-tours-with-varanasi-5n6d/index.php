...
<head>
    ...
    <title>Golden Triangle Tour with Varanasi - India Day Trip</title>
    <meta name="author" content="India Day Trip">
    <meta name="description"
        content="Explore India's Golden Triangle plus the spiritual city of Varanasi on this 6-day tour. Visit Delhi, Agra, Jaipur, and experience the Ganges at sunrise.">
    <meta name="keywords" content="Golden Triangle Varanasi, India tour, Delhi Agra Jaipur Varanasi, spiritual tour India, Ganges tour">
    ...
    <div class="breadcumb-wrapper" data-bg-src="../assets/img/bg/breadcumb-bg.jpg">
        <div class="container">
            <div class="breadcumb-content">
                <h1 class="breadcumb-title">Golden Triangle Tour with Varanasi</h1>
                <ul class="breadcumb-menu">
                    <li><a href="home-travel.php">Home</a></li>
                    <li>Golden Triangle Varanasi</li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="tour-page-single">
              ...
              >
                ...
                >
                  <div class="tour-slider-img">
                    <img src="assets/img/tour/golden_varanasi_1.jpg" alt="Golden Triangle Varanasi" />
                  </div>
                </div>
                <div
                  class="swiper-slide"
                ...
                >
                  <div class="tour-slider-img">
                    <img src="assets/img/tour/golden_varanasi_2.jpg" alt="Golden Triangle Varanasi" />
                  </div>
                </div>
                <div
                  class="swiper-slide"
                ...
                >
                  <div class="tour-slider-img">
                    <img src="assets/img/tour/golden_varanasi_3.jpg" alt="Golden Triangle Varanasi" />
                  </div>
                </div>
                <div
                  class="swiper-slide"
          ...
          <div class="page-content">
            ...
            <p class="box-text mb-50">
              This 6-day journey combines the historical Golden Triangle (Delhi, Agra, Jaipur) with Varanasi's profound spiritual atmosphere, offering a complete exploration of India's diverse cultural heritage.
            </p>
            <h2 class="box-title">Highlights</h2>
            <p class="box-text mb-30">
              Discover India's cultural and spiritual diversity with our comprehensive Golden Triangle plus Varanasi itinerary.
            </p>
            <div class="checklist mb-50">
              <ul>
                <li>Delhi's Mughal and British monuments</li>
                <li>Taj Mahal and Agra Fort exploration</li>
                <li>Jaipur's Amber Fort and City Palace</li>
                <li>Varanasi Ganges River boat ride at sunrise</li>
                <li>Sarnath archaeological site visit</li>
                <li>Traditional Indian cuisine experiences</li>
                <li>Cultural performances and local interactions</li>
              </ul>
            </div>
            <h2 class="box-title">Included and Excluded</h2>
            <p class="blog-text mb-35">
              Everything you need for a comfortable exploration of India's Golden Triangle and Varanasi is included.
            </p>
      ...
      <div class="col-xxl-4 col-lg-5">
        <aside class="sidebar-area">
          ...
          <div class="widget widget_tag_cloud">
            ...
            <div class="tagcloud">
              <a href="tour.html">Golden Triangle</a> <a href="tour.html">Varanasi</a>
              <a href="tour.html">Spiritual</a> <a href="tour.html">Ganges</a>
