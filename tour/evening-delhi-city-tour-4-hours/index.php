...
<head>
    ...
    <title>Evening Delhi City Tour 4 Hours - India Day Trip</title>
    <meta name="author" content="India Day Trip">
    <meta name="description"
        content="Experience Delhi's illuminated monuments and bustling evening life on this 4-hour city tour. Discover the city's magic after dark.">
    <meta name="keywords" content="Evening Delhi tour, Delhi night tour, Delhi city tour, illuminated monuments, Delhi evening sightseeing">
    ...
    <div class="breadcumb-wrapper" data-bg-src="../assets/img/bg/breadcumb-bg.jpg">
        <div class="container">
            <div class="breadcumb-content">
                <h1 class="breadcumb-title">Evening Delhi City Tour 4 Hours</h1>
                <ul class="breadcumb-menu">
                    <li><a href="home-travel.php">Home</a></li>
                    <li>Evening Delhi City Tour</li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="tour-page-single">
              ...
              >
                ...
                >
                  <div class="tour-slider-img">
                    <img src="assets/img/tour/evening_delhi_1.jpg" alt="Evening Delhi Tour" />
                  </div>
                </div>
                <div
                  class="swiper-slide"
                ...
                >
                  <div class="tour-slider-img">
                    <img src="assets/img/tour/evening_delhi_2.jpg" alt="Evening Delhi Tour" />
                  </div>
                </div>
                <div
                  class="swiper-slide"
                ...
                >
                  <div class="tour-slider-img">
                    <img src="assets/img/tour/evening_delhi_3.jpg" alt="Evening Delhi Tour" />
                  </div>
                </div>
                <div
                  class="swiper-slide"
          ...
          <div class="page-content">
            ...
            <p class="box-text mb-50">
              Perfect for travelers seeking a different perspective of India's capital, this evening tour captures Delhi's essence when the monuments are bathed in golden light and the streets come alive with energy.
            </p>
            <h2 class="box-title">Highlights</h2>
            <p class="box-text mb-30">
              Experience Delhi's evening charm with our carefully curated 4-hour itinerary.
            </p>
            <div class="checklist mb-50">
              <ul>
                <li>Illuminated Red Fort and Chandni Chowk</li>
                <li>Jama Masjid mosque visit</li>
                <li>Connaught Place evening stroll</li>
                <li>India Gate and Rajpath at dusk</li>
                <li>Street food tasting experience</li>
                <li>Photography of lit monuments</li>
                <li>Local market exploration</li>
              </ul>
            </div>
            <h2 class="box-title">Included and Excluded</h2>
            <p class="blog-text mb-35">
              Everything you need for a delightful evening exploration of Delhi is included.
            </p>
              ...
              >
                <div class="tour-grid-plan">
                  <div class="checklist">
                    <ul>
                      <li>
                        4:00 PM: Pickup from your hotel.
                      </li>
                      <li>Visit illuminated Red Fort.</li>
                      <li>
                      ...
                      <li>
                        Drive past India Gate and Rajpath.
                      </li>
                      <li>
        ...
        <aside class="sidebar-area">
          ...
          <div class="widget">
            ...
            <div class="recent-post-wrap">
              ...
              <div class="recent-post">
                <div class="media-img">
                  <a href="taj-mahal-sunrise-and-old-delhi-tour.html"
                    ><img
                      src="assets/img/blog/taj-sunrise-old-delhi-1.jpg"
                      alt="Taj Mahal Sunrise Old Delhi Tour"
                  /></a>
                </div>
                <div class="media-body">
                  <h4 class="post-title">
                    <a class="text-inherit" href="taj-mahal-sunrise-and-old-delhi-tour.html"
                      >Taj Mahal Sunrise And Old Delhi Tour</a
                    >
                  </h4>
                  <div class="recent-post-meta">
                    <a href="tour.html"
          ...
          <div class="widget widget_tag_cloud">
            ...
            <div class="tagcloud">
              <a href="tour.html">Evening Tour</a> <a href="tour.html">Delhi</a>
              <a href="tour.html">City Tour</a> <a href="tour.html">Night</a>
