...
<head>
    ...
    <?php renderSEOHead('terms_conditions'); ?>
    <meta property="og:description"
        content="Review the terms and conditions for booking tours with India Day Trip. Understand our policies for Same Day Tours, Taj Mahal Tours, and Golden Triangle Tours in Agra, Delhi, and Jaipur.">
...
<body>
    ...
    <div class="space">
        <div class="container">
            <div class="row">
                <div class="col-lg-10 mx-auto offset-lg-2">
                    ...
                    <div class="terms-content">
                        ...
                        <h3>Use License</h3>
                        <p>Permission is granted to temporarily download one copy of the materials on India Day Trip's
                            website for personal, non-commercial transitory viewing only.</p>

                        <h3>Booking and Payment</h3>
                        <p>All bookings are subject to availability and confirmation. Payment terms will be specified at
                            the time of booking. Cancellations and refunds are subject to our cancellation policy.</p>

                        <h3>User Responsibilities</h3>
                        <p>You agree to provide accurate and complete information when making bookings. You are
                            responsible for maintaining the confidentiality of your account information.</p>

                        <h3>Limitation of Liability</h3>
                        <p>In no event shall India Day Trip or its suppliers be liable for any damages arising out of
                            the use or inability to use the materials on our website.</p>
