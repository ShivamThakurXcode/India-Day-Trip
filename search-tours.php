...
$filters = [];
if ($location) $filters[] = "Location: " . ucfirst($location);
if ($category) $filters[] = "Type: $category";
if ($duration) $filters[] = "Duration: $duration Day" . ($duration > 1 ? 's' : '');
if ($search) $filters[] = "Search: $search";
if ($rating) $filters[] = "Rating: $rating+ stars";
...
<head>
    ...
    <meta name="description" content="Search and find your perfect tour with India Day Trip.">
    <meta name="keywords" content="Search tours India, Taj Mahal tours, Golden Triangle tours">
                        ...
                        <form method="GET" action="search-tours.php">
                            <div class="filter-group mb-3">
                                ...
                                <select name="location" class="form-select custom-select">
                                    ...
                                    <option value="rajasthan" <?php echo ($location == 'rajasthan') ? 'selected' : ''; ?>>Rajasthan</option>
                            ...
                            <div class="filter-group mb-3">
                                ...
                                <select name="tourType" class="form-select custom-select">
                                    ...
                                    <option value="taj-mahal" <?php echo ($tourType == 'taj-mahal') ? 'selected' : ''; ?>>Taj Mahal Tour</option>
                                    <option value="golden-triangle" <?php echo ($tourType == 'golden-triangle') ? 'selected' : ''; ?>>Golden Triangle</option>
                                    <option value="rajasthan" <?php echo ($tourType == 'rajasthan') ? 'selected' : ''; ?>>Rajasthan Tour</option>
                                </select>
                            </div>
                            <div class="filter-group mb-3">
                            ...
                            <div class="filter-group mb-3">
                                ...
                                <input type="text" name="search" class="form-control" placeholder="Tour name..." value="<?php echo htmlspecialchars($search ?? ''); ?>">
                            </div>
                                ...
                                <div class="col-md-auto">
                                    <div class="sorting-filter-wrap">
                                        <form class="woocommerce-ordering" method="get">
                                            ...
                                            <input type="hidden" name="tourType" value="<?php echo htmlspecialchars($tourType ?? ''); ?>">
                                            ...
                                            <select name="orderby" class="orderby" aria-label="tour order" onchange="this.form.submit()">
